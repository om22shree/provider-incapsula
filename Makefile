...
PROJECT_REPO ?= github.com/om22shree/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-incapsula_v3.23.1
...
xpkg.build.provider-incapsula: do.build.images
